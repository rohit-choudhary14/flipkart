...
<%-- 
    Document   : index
    Created on : 30 Mar, 2022, 7:50:44 PM
    Author     : rohit
--%>
...
<nav class="navbar sticky-top" style="background-color:#3392F3;">
    <h2 style="color:white;font-family:AR BERKLEY">Flipkart</h2>
                ...
                <div class="col-sm-2">
                    ...
                    <div class="row">
                        <div class="nav" rel="<%=cat_code%>" >
                            ...
                            <div class="dropdown-menu position-absolute  rounded-0 w-100 m-0" id="subcat-<%=cat_code%>" style="box-shadow:1px 1px 2px rgba(0,0, 0, 0.4);background-color:white">
                                <%
  ...
  <section>
        <div class="container-fluid" style="margin-top:5px;" id="main">
